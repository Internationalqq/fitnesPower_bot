    ...
    async def parse_with_groq(self, text: str) -> Optional[Dict]:
        ...
        try:
            ...
            prompt = (
                ...
                "   - КРИТИЧЕСКИ ВАЖНО: Если готовое блюдо указано как '1шт' (например 'чизбургер Burger King 1шт'), "
                "   ищи КБЖУ для ОДНОЙ ПОРЦИИ готового блюда, НЕ используй данные на 100г!\n"
                "   - Для готовых блюд из ресторанов '1шт' означает ОДНУ ПОРЦИЮ готового блюда, а не 100г!\n"
                ...
                "- Если указано '1шт' - ищи КБЖУ для ОДНОЙ ПОРЦИИ готового блюда (НЕ на 100г!)\n"
                "- Если указано количество в граммах (например 'бургер 200г') - используй это количество\n"
                "- НЕ используй данные на 100г для готовых блюд, если указано '1шт'!\n"
                ...
                "- Для готовых блюд из ресторанов проверяй реалистичность: стандартный чизбургер Burger King ~312-330 ккал на 1шт, "
                "а НЕ 540 ккал (540 ккал - это двойной чизбургер или данные на 100г)\n"
                "- Если находишь данные, которые кажутся слишком большими для '1шт' готового блюда, проверь - возможно это данные на 100г или двойная порция\n\n"
                ...
                '   (Обрати внимание: это данные для ОДНОЙ ПОРЦИИ готового блюда, НЕ на 100г!)\n'
                ...
                '   (Обрати внимание: НЕ разбивай на компоненты! Ищи данные для готового блюда целиком! Для "1шт" - данные для ОДНОЙ ПОРЦИИ, а не на 100г!)\n\n'
                "ВАЖНО:\n"
